                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress shadow-sm" style="height: 6px;">
                            <div class="progress-bar bg-gradient-success" role="progressbar" style="width: 57%;">
                            </div>
                        </div>
                    </div>
                    <!--end card body-->
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress shadow-sm" style="height: 6px;">
                            <div class="progress-bar bg-gradient-danger" role="progressbar" style="width: 57%;">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress shadow-sm" style="height: 6px;">
                            <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: 57%;">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="progress shadow-sm" style="height: 6px;">
                            <div class="progress-bar bg-gradient-info" role="progressbar" style="width: 57%;"></div>
                        </div>
                    </div>
                </div>
            </div>
