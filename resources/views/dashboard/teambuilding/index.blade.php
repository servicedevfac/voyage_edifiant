...
<!-- Start Content-->
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Liste des Team Building</h4>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('teambuilding.ajouter') }}" class="btn btn-soft-danger"> Ajouter team building</a>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    @foreach ($teambuildings as $key => $teambuilding)
                                        <tr>
                                            <th scope="row">{{ $key + 1 }}</th>
                                            <td>{{ $teambuilding->titre }}</td>
                                            <td>{{ $teambuilding->nom_lieu }}</td>
                                            <td>
                                                @php
                                                    $activites = json_decode($teambuilding->activite, true);
                                                @endphp

                                                @if(is_array($activites))
                                                    <p><strong>Activités :</strong> {{ implode(', ', $activites) }}</p>
                                                @else
                                                    <p><strong>Activités :</strong> Aucune activité sélectionnée</p>
                                                @endif

                                            </td>
                                            <td>{!! $teambuilding->courte_description !!}</td>
                                            <td>
