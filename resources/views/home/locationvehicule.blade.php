        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="#" class="primary-btn">Je loue maintenant </a>
                </div>
                <div class="container">
    ...
    <section class="">
        <div class="container">
            <div class="row gx-5 gy-4">
                <div class="col-6 col-sm-6 col-md-3 col-lg-3" id="bouton1">
                    <div class="car2 car-active p-b10  d-flex align-items-center">
                        <div class="car-image">
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3" id="bouton2">
                    <div class="car2 p-b10  d-flex align-items-center">
                        <div class="car-image">
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3" id="bouton3">
                    <div class="car2 p-b10  d-flex align-items-center">
                        <div class="car-image">
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3" id="bouton4">
                    <div class="car2 p-b10  d-flex align-items-center">
                        <div class="car-image">
            ...
            <div id="contenu1" class="voircontenu" style="display: block;">
                <div class="row gx-4 gy-4 m-t50">
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/citadine_1.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Suzuki Dzire</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                ...
                                <div class="bas d-flex m-t30" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        ...
                                        <p class="text-leger">Boîte de vitesse</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/malfunction-indicador.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">Energie</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/clim.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">Climatiseur</p>
                                    </div>
                                </div>
                                    
                                <div class="mx-auto" style="width: fit-content; white-space: nowrap;">
                                    <button type="button" class="btn m-t30 center" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Reserver maintenant</button>
                                </div>
                            </div>
                            <div class="price">
                                <p class="normal-text-white fs-5" >A partir de 35 000 Fcfa</p>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/citadine-1.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Audi A1</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative; width: 100%">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/citadine-2.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Opel Corsa</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
            ...
            <div id="contenu2" class="voircontenu">
                <div class="row gx-4 gy-4 m-t50">
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/car3.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Mitsubishi</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                                    ...
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/valise.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">04 Valises</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/siege.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">05 Sièges</p>
                                ...
                                <div class="mx-auto" style="width: fit-content; white-space: nowrap;">
                                    <button type="button" class="btn m-t30 center" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                    Reserver maintenant
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/4x4_1.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Ford</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/4x4_2.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Duster DACIA</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                                    ...
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/valise.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">05 Valises</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/siege.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">05 Sièges</p>
            ...
            <div id="contenu3" class="voircontenu">
                <div class="row gx-4 gy-4 m-t50">
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/suv1.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Toyota</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/suv2.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Hyundai</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative; width: 100%">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/suv3.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">SUV Suzuki</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
            ...
            <div id="contenu4" class="voircontenu">
                <div class="row gx-4 gy-4 m-t50">
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/mini_bus_voyagedifiant.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Mini Bus Hyundai</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                                    ...
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/valise.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">01 Valise</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/siege.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">12 Sièges</p>
                                    </div>
                                </div>
                                <div class="bas d-flex m-t30" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                            ...
                            <div class="price">
                                <p class="normal-text-white fs-5" >A partir de 70 000 Fcfa</p>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/mini_bus_voyagedifiant1.png')}}" alt="voiture">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Mini Bus Toyota</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                    ...
                    <div class=" col-sm-6 col-md-6 col-lg-4" >
                        <div class="first" style="background-color: #f5f5f5; position: relative;">
                            <div class="car3 mx-auto d-block">
                                <img src="{{ url('assets/front/images/mini_bus_voyagedifiant2.png')}}" alt="minibus">
                            </div>
                            <p class="normal-text text-center m-b50 fs-3">Mini Bus Huyndai</p>
                            <div class="bass " style="background-color: #F2F2F9; padding: 20px 25px;">
                                <div class="bas d-flex m-t20" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/porte.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">03 Portes</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/valise.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">05 Valise</p>
                                    </div>
                                    <div class="d-flex option" style="align-items: center;">
                                        <img src="{{ url('assets/front/images/siege.png')}}" class="" alt="" style="height: 30px;">
                                        <p class="text-leger">32 Sièges</p>
                                    </div>
                                </div>
                                <div class="bas d-flex m-t30" style="justify-content: space-between;">
                                    <div class="d-flex option" style="align-items: center;">
      ...
      <section class="py-5 m-t100">
        <div class="container ">
          <div class="title text-center ">
            <h3 class="primary-text mb-3">Decouvrez notre équipe de chauffeurs</h3>
      ...
      <section class="py-5 m-t100" style="background-image: url('{{ url('assets/front/images/bg1.png')}}');">
        <div class="container ">
          ...
          <div class="contentCo m-t50">
            ...
            <p>
                Nous savons que vous n’aimez pas les mauvaises surprises (Véhicules sales , vieux siège ...), c’est pourquoi chaque voiture est soigneusement nettoyée et révisée avant de vous être remise. Vous montez dans une voiture propre et confortable.
            </p>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" method="POST" action="{{ route('reservationvehicules.store') }}">
                            @csrf

                            <div class="col-md-4">
                                <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer votre nom (obligatoire)">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <input type="tel" class="form-control" id="telephone" name="telephone" placeholder="Entrer votre numero de téléphone">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="numero_piece" name="numero_piece" placeholder="Entrer votre numero de pièce">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="marque_vehicule" name="marque_vehicule" placeholder="Marque du vehicule">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="nom_vehicule" name="nom_vehicule"  placeholder="Nom du véhicule">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="dateDebut" name="date_debut" placeholder="A partir du 12/11/2025">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="dateFin" name="date_fin" placeholder="jusqu'au 13/11/2025">
                            </div>
                            <div class="col-12">
                                <textarea name="message" id="message" name="message" class="form-control" placeholder="Entrez votre message"></textarea>
                            </div>
