...
<main>
      ...
      <div class="carousel-item active">
        ...
        <div class="carousel-caption">
          <h2 class="mb-4">Voyagez, Explorez, Vivez l'expérience</h2>
              ...
              <a href="#reserv" class="primary-btn">Planifier votre aventure</a>
        </div>
  ...
  <section class="py-5" style="padding-bottom: 0px !important;">
    <div class="container">
      <div class="title text-center">
        <h3 class="primary-text mb-3">Decouvrez notre agence de voyage</h3>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row gx-5">
        ...
        <div class="col-lg-7 col-md-12 ">
          ...
          <a href="#reserv" class="primary-btn">Reserver en un clic</a>
        </div>
      </div> 
    </div>
  </section>
    ...
    <div class="container">
      <div class="row gx-5 p-b150">
        ...
        <div class="col-lg-8 col-md-12  m-t50">
          ...
          <p class="p-t30 text-leger">
            <b class="normal-text">Chez Voyage Édifiant, on transforme votre projet de voyage en une expérience fluide, simple et sans stress. </b><br>
            Réservation de billet, assistance visa, hébergement, conseils … <br>
                    Vous rêvez de partir, nous vous aidons à y arriver.
          </p>
          <div class="m-t30">
              <a href="#reserv" class="primary-btn">Embarquer maintenant</a>
          </div>
  ...
  <section class="p-b150 m-b50 m-t100" style="background-image: url('images/bg2.png');">
