          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item active banner">
              ...
              <div class="carousel-captions">
                  ...
                  <h2 class="mb-4 title2">À propos de nous</h2>
            ...
            <div class="row gx-5">
              ...
              <div class="col-lg-7 col-md-12 ">
                ...
                <p class="p-b30 why m-t40">
                  ...
                  Nous proposons la location de véhicules, l’organisation de team building et un accompagnement complet pour vos projets de voyage (réservations de billets, assistance visa, conseils...). <br>
                  ...
                  <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="car p-b10  d-flex align-items-center">
                      ...
                      <a href="{{ route('locationvehicule') }}" style="text-decoration: none; color: black;">
                        ...
                        <p style="white-space: nowrap; font-size: 14px; font-weight: 600;">Location de véhicule</p>
