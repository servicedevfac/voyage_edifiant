        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-captions">
              ...
              <h2 class="mb-4 secondary-text-white fs-1">Préparez-vous pour une aventure inoubliable au cœur d’un pays vibrant et coloré !</h2>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="decouverte d-flex justify-content-center align-items-center" style="background-image: url('{{ url($decouverte->imageprincipale) }}'); background-size: cover; background-position: center;">
                                ...
                                <div class="text-center m-t30">
                                    ...
                                    <a href="{{ route('decouverteshow', $decouverte->slug) }}" class="secondary-btn ">Découvrez la ville</a>
