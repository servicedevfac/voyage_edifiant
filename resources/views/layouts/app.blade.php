...
<html lang="fr">
    <head>
        ...
        <meta name="google-site-verification" content="Z__bjJzlg-hmJJoDrwbwuU7Ea8sPvnB9bvxe72mSnvA" />
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-RL5ZBJ011W"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
        
          gtag('config', 'G-RL5ZBJ011W');
        </script>
    ...
    <body>
        <header>
            <nav class="navbar">
                <div class="logo">
                    <a href="{{ route('accueil') }}" ><img src="{{ url('assets/front/images/logo.png') }}" alt="Logo"></a>
                </div>
                <ul class="nav-links">
                    <li class="{{ Route::is('accueil') ? 'active' : '' }} menu-active"><a href="{{ route('accueil') }}">Accueil</a></li>
                    <li class="{{ Route::is('apropos') ? 'active' : '' }} menu-active"><a href="{{ route('apropos') }}">À Propos</a></li>
                    <li class="{{ Route::is('locationvehicule') ? 'active' : '' }} menu-active"><a href="{{ route('locationvehicule') }}">Location de Véhicules</a></li>
            ...
            <section class="footer-bottom">
                <div class="about">
                    <div class="title-trait d-flex align-items-center">
                        ...
                        <h4 class="secondary-text-white ms-2">À propos de nous</h4>
                    </div>
                    <p class="text-leger-white m-t20">Nous proposons la location de véhicules, l’organisation de team building et un accompagnement complet pour vos projets de voyage (réservations de billets, assistance visa, conseils...). 
                    </p>
                    <div class="socials m-t20">
                        <a href="https://www.facebook.com/share/1D2E2xQZxJ/?mibextid=wwXIfr" target="_blank" style="text-decoration: none; color: white;"><i class="fab fa-facebook"></i></a>
                ...
                <div class="links">
                    ...
                    <ul>
                        ...
                        <li class="m-t10"><a href="{{ route('apropos') }}" class="normal-text-white">À propos</a></li>
                        ...
                        <li class="m-t10"><a href="{{ route('decouverte') }}" class="normal-text-white">Découverte</a></li>
                        ...
                        @auth
                            <li class="m-t10"><a href="{{ route('dashboard') }}" class="normal-text-white text-warning" style="color: #ffc107 !important;"><i class="fas fa-lock"></i> Administration</a></li>
                        @endauth
                    </ul>
                </div>
