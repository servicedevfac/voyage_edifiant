...
class DecouverteAdminController extends Controller
{
    /**
    ...
    public function update(Request $request, Decouverte $decouverte)
    {
        ...
        $imgSecondaires = is_array($decouverte->imagesecondaire) ? $decouverte->imagesecondaire : (json_decode($decouverte->imagesecondaire, true) ?? []);
